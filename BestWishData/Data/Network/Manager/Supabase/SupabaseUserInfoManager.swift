...
public protocol SupabaseUserInfoManager {
    /// 유저 정보 불러오기
...
/// Supabase 유저 정보 매니저
public final class SupabaseUserInfoManagerImpl: SupabaseUserInfoManager {
    ...
    /// 유저 정보 불러오기
    public func getUserInfo() async throws -> UserDTO {
        do {
