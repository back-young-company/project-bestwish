...
extension SupabaseOAuthManagerImpl {
    ...
    /// 애플 로그인 시도
    public func logInApple() async throws -> (authorizationCode: String, session: Supabase.Session) {
    ...
    public func requestClientSecret(_ keyChain: KeyChainManager) async throws -> String {
    ...
    /// 애플 회원탈퇴
    public func revokeAccount(_ token: String, _ clientSecret: String) async throws {
    ...
    public func requestAppleAccessToken(code: String, clientSecret: String) async throws -> Data {
        do {
    ...
    public func parsingAccessToken(data: Data) throws -> String {
